...
Image.create(url_name: "men_images/tyler-nix-Zhh3WM2ko3s-unsplash.jpg", title:"Retro 80s",
             caption:"Blast to the past", price:"$38.99", human_type: "male", popular: 5, new_arrival: false,
             saved_to_list: false)
...
Image.create(url_name: "men_images/zahir-namane-TjUJJACTav4-unsplash.jpg", title:"Business Casual",
             caption:"Straight to the point", price:"$34.99", human_type: "male", popular: 9, new_arrival: true,
             saved_to_list: false)

Image.create(url_name: "women_images/marionel-luciano-f615lHRUJqw-unsplash.jpg", title:"Summer Flow",
             caption:"Feel the breeze", price:"$49.99", human_type: "female", popular: 5, new_arrival: false,
             saved_to_list: false)
Image.create(url_name: "women_images/mark-adriane-V7IJzp_ElQc-unsplash.jpg", title:"Bright Days",
             caption:"Sunshine everyday", price:"$29.99", human_type: "female", popular: 9, new_arrival: false,
             saved_to_list: false)
Image.create(url_name: "women_images/monica-silva-VlMMBxSZuSI-unsplash.jpg", title:"Nightly Allure",
             caption:"Draws in the eyes", price:"$34.99", human_type: "female", popular: 4, new_arrival: true,
             saved_to_list: false)
...
Image.create(url_name: "kids_images/ben-white-EMZxDosijJ4-unsplash.jpg", title:"Autumn Duos",
             caption:"A set for kids", price:"$52.99", human_type: "kids", popular: 5, new_arrival: false,
             saved_to_list: false)
Image.create(url_name: "kids_images/sander-weeteling-Itbk3pUYhpY-unsplash.jpg", title:"Playful Autumn",
             caption:"To play without worries", price:"$41.99", human_type: "kids", popular: 8, new_arrival: true,
             saved_to_list: false)
...
Image.create(url_name: "kids_images/terricks-noah-n9R0MN3XGvY-unsplash.jpg", title:"Smarts",
             caption:"Dress to impress", price:"$32.99", human_type: "kids", popular: 9, new_arrival: false,
             saved_to_list: false)

#rails generate scaffold Image url_name:string title:string caption:string price:string human_type:string popular:integer new_arrival:boolean saved_to_list:boolean --force